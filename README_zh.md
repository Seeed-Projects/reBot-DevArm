...
| **Pinocchio 适配** | ✅ 完成 | 适配 Pinocchio框架、实现机械臂正逆运动学及动力学重力补偿功能 |[Wiki](https://wiki.seeedstudio.com/cn/rebot_arm_b601_dm_pinocchio_meshcat/) [reBotArm_control_py](https://github.com/vectorBH6/reBotArm_control_py)|
